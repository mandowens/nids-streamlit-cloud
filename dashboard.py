...
DEFAULT_PIPELINE_PATH = APP_DIR / "pipeline.py"
FALLBACK_PIPELINE_PATH = APP_DIR / "pipeline.py"
UPLOAD_ROOT = APP_DIR / "uploaded_datasets"
ARTIFACT_ROOT = APP_DIR / "dashboard_v4_6_preset_selftest_report_artifacts"
JOB_ROOT = APP_DIR / "dashboard_v4_6_preset_selftest_report_jobs"
DB_PATH = APP_DIR / "nids_dashboard_cloud.sqlite"
...
def render_account_box():
    ...
    st.sidebar.caption(f"Registry DB: `{DB_PATH.name}` · Cloud-ready")
...
def main():
    st.set_page_config(page_title="Hybrid NIDS Research Studio Cloud", page_icon="🛡️", layout="wide")
    init_state()
    ...
    st.info("Cloud deployment defaults to a lighter setup. ML workflows are recommended on Streamlit Community Cloud; DL will auto-fallback when runtime support is unavailable.")
